...
\begin{lemma}\cite{diaz_local_1985}\label{the interpolation-trace lemma}
...
\begin{proof}
	...
	\end{equation}
Second step. We start from the elementary trace result \cite{adams_sobolev_2003}: there exists $C_{3}>0$ such that for any $u \in C^{1}(\bar{G})$ we have
...
\section{a lemma related to convergence in $L_1$}
...
\section{$W^{1,1}$ embeding coefficient}
