...
\end{proposition}
\begin{proof}
	Without loss of generality, we may assume that $f\geq0$ in the sense of distribution.
	...
	\begin{align*}
		...
		&\leq \int_{|x-y|<\delta}K(x-y)|f(y)-f(x)|\dd y + \int_{|x-y|\geq \delta}K(x-y)|f(y)-f(x)|\dd y\\
...
%	For any $\varepsilon>0$, there exists $R>1>\delta>0$ such that $\|f\|_{\mathbb R^n\setminus B_{R-1}}<\varepsilon$,
	...
	Therefore,
	\[
	\lim_{t\searrow0}	t^{\frac{n}{2}\left(1-\frac1p\right)}\|K*f\|_p 
